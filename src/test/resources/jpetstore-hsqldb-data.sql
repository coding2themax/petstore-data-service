...
create table petstore.PHOTO (
    photoid NUMERIC(80) not null,
    ...
    uploadpath varchar(80) not null,
    photourl varchar(80) not null,
    constraint pk_photo primary key (photoid)
    constraint fk_photo_1 foreign key (petid) references petstore.PET (petid) 
);

create table petstore.TAG (
    tagid NUMERIC(80) not null,
    tagname varchar(80) not null,
    petid NUMERIC(10) not null,
    constraint pk_tag primary key (tagid),
    constraint fk_tag_1 foreign key (petid) references petstore.PET (petid)
);

create TYPE petstore.STATUS AS ENUM ('available', 'pending', 'sold');
alter table petstore.PET add column petstatus petstore.STATUS not null;
create table petstore.PET (
    petid NUMERIC(10) not null,
    category numberic(10) not null,
    name varchar(80) null,
    descn varchar(255) null,
    constraint pk_pet primary key (petid),
    constraint fk_pet_1 foreign key (category) references petstore.CATEGORY (catid)
);
...
INSERT INTO petstore.CATEGORY VALUES ('FISH','Fish','<image src="../images/fish_icon.gif"><font size="5" color="blue"> Fish</font>');
INSERT INTO petstore.CATEGORY VALUES ('DOGS','Dogs','<image src="../images/dogs_icon.gif"><font size="5" color="blue"> Dogs</font>');
INSERT INTO petstore.CATEGORY VALUES ('REPTILES','Reptiles','<image src="../images/reptiles_icon.gif"><font size="5" color="blue"> Reptiles</font>');
INSERT INTO petstore.CATEGORY VALUES ('CATS','Cats','<image src="../images/cats_icon.gif"><font size="5" color="blue"> Cats</font>');
INSERT INTO petstore.CATEGORY VALUES ('BIRDS','Birds','<image src="../images/birds_icon.gif"><font size="5" color="blue"> Birds</font>');
...
INSERT INTO petstore.PET VALUES (1,1,'Angelfish','<image src="../images/fish1.gif">Salt Water fish from Australia');
insert into petstore.PET VALUES (2,1,'Tiger Shark','<image src="../images/fish4.gif">Salt Water fish from Australia');    
